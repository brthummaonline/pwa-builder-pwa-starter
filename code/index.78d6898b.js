...
`;var Fi=Object.defineProperty,Wi=Object.getOwnPropertyDescriptor,Tn=(e,t,r,n)=>{for(var o=n>1?void 0:n?Wi(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(o=(n?s(t,r,o):s(o))||o);return n&&o&&Fi(t,r,o),o};let _e=class extends V{constructor(){super();this.message="Welcome!"}static get styles(){return[zi,Ht`
    ...
    `]}async firstUpdated(){console.log("This is your home page")}share(){navigator.share&&navigator.share({title:"PWABuilder pwa-starter",text:"Check out the PWABuilder pwa-starter!",url:"https://github.com/pwa-builder/pwa-starter"})}render(){return mt`
      ...
      <main>
        <div id="welcomeBar">
          ...
          <sl-button href="${"/pwa-builder-pwa-starter/"}about" variant="primary">Navigate to About</sl-button>
        </div>
    ...
    `}render(){return mt`
      <header>
        ...
        <div id="back-button-block">
          ${this.enableBack?mt`<sl-button href="${"/pwa-builder-pwa-starter/"}">
            Back
          </sl-button>`:null}
    ...
    `}constructor(){super()}firstUpdated(){var t;new H((t=this.shadowRoot)==null?void 0:t.querySelector("#routerOutlet")).setRoutes([{path:"/pwa-builder-pwa-starter/",animate:!0,children:[{path:"",component:"app-home"},{path:"about",component:"app-about",action:async()=>{await Vn(()=>import("./app-about.c2425e2e.js"),[])}}]}])}render(){return mt`
      <div>
        <main>
...
//# sourceMappingURL=index.78d6898b.js.map
